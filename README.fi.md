# Laskuri
Luo React-laskurisovellus, jossa on kolme painiketta, joiden avulla käyttäjä voi hallita laskurin arvoa.

**Mitä jo osaat**
- Perus React-komponentin luominen
- `useState`-hookin käyttö laskurin hallintaan
